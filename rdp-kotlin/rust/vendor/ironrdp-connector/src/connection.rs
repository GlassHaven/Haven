            ...
            optional_data: ClientCoreOptionalData {
                ...
                early_capability_flags: {
                    let mut early_capability_flags = ClientEarlyCapabilityFlags::VALID_CONNECTION_TYPE
                        ...
                        // Haven patch: advertise EGFX/DRDYNVC support so servers
                        // (esp. gnome-remote-desktop) deliver the Graphics
                        // Pipeline Extension instead of legacy slow-path bitmap.
